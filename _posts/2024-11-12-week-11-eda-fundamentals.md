...
We're now entering **Phase 3** of the course. In [Phase 1](/cs249r_fall2025/course/schedule/#phase-1-ai-for-software-weeks-3-5) (AI for Software), we optimized code with rapid iteration. Compile, test, adjust. In [Phase 2](/cs249r_fall2025/course/schedule/#phase-2-ai-for-architecture-weeks-6-10) (AI for Architecture), we designed systems with some validation before deployment, but still with opportunities to adapt. In **Phase 3** (AI for Chip Design), we enter a domain where **decisions are irrevocable** and **validation is incomplete**.
...
Now that you've seen the entire chip design flow, let's step back and understand what makes this uniquely challenging compared to everything we've tackled in [Phase 1](/cs249r_fall2025/course/schedule/#phase-1-ai-for-software-weeks-3-5) and [Phase 2](/cs249r_fall2025/course/schedule/#phase-2-ai-for-architecture-weeks-6-10).
...
**The Phase 3 exploration asks:** Can modern AI agents (LLMs, learned models, reinforcement learning) fundamentally change this?
...
*For detailed readings, slides, and materials for this week, see [Week 11 in the course schedule](/cs249r_fall2025/course/schedule/#week-11---eda-fundamentals).*
